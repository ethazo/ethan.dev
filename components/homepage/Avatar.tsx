...
const Avatar = () => {
  ...
  return (
    <div
      className="transition-transform delay-[300ms] duration-[59000ms] ease-[cubic-bezier(0.3,0,0.8,1)] hover:-translate-x-1/2 hover:-translate-y-1/2 hover:rotate-[666turn]"
    ...
    >
      ...
      >
        <Image src={'/static/favicons/avatar.png'} alt="avatar" width={430} height={430} />
      </div>
    </div>
  )
}
